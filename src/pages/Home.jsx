  ...
  return (
    <Link to={`/product/${product.id}`} style={{ textDecoration: "none" }}>
      <div
        ...
        onMouseEnter={(e) => {
          e.currentTarget.style.boxShadow = "0 8px 32px rgba(90,102,96,0.13)";
      ...
      >
        ...
        <div
          style={{ padding: isMobile ? "12px 14px 16px" : "16px 18px 20px" }}
        >
          <div
            style={{
              fontSize: 10,
  ...
  return (
    <div style={{ fontFamily: "'Archivo',sans-serif", color: c.dark }}>
      ...
      >
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              "linear-gradient(90deg, rgba(0,0,0,0.55) 0%, rgba(0,0,0,0.2) 100%)",
          }}
        />
        <div style={{ position: "relative", zIndex: 1, maxWidth: 600 }}>
          ...
          >
            Lightweight mesh clothing that physically blocks ticks and insects.
            No DEET, no chemicals — just a smart layer between you and nature.
          </p>
          <p
            style={{
              fontSize: 13,
          ...
          <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
            ...
            <Link
              to="/how-it-works"
              style={{ ...BTNO, textDecoration: "none" }}
            >
              How It Works
            </Link>
          </div>
      ...
      >
        ...
        {!isMobile && (
          <div style={{ width: 1, height: 20, background: c.glL }} />
        )}
        <div
          style={{
            fontSize: 12,
          ...
          {[
            {
              label: "Men",
              to: "/shop/men",
              img: "/images/product-men-jacket-front.png",
            },
            {
              label: "Women",
              to: "/shop/women",
              img: "/images/lifestyle-women-outdoor.png",
            },
            {
              label: "Kids",
              to: "/shop/kids",
              img: "/images/lifestyle-kids-forest.png",
            },
            {
              label: "Bundles",
              to: "/shop/bundles",
              img: "/images/lifestyle-couple-forest.png",
            },
          ].map((cat, i) => (
              ...
              >
                ...
                <div
                  style={{
                    ...
                    inset: 0,
                    background:
                      "linear-gradient(0deg, rgba(0,0,0,0.5) 0%, rgba(0,0,0,0.1) 60%)",
                  }}
                />
      ...
      >
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 48 }}>
            ...
            <h2 style={{ ...H2, textAlign: "center", marginBottom: 12 }}>
              Like a screen porch for your body
            </h2>
            <p
              style={{
            ...
            >
              The mesh physically blocks ticks while letting air through.
              Simple, effective, chemical-free.
            </p>
          </div>
          <div
            style={{
            ...
            {[
              {
                step: "01",
                icon: "🕷️",
                title: "Ticks crawl upward",
                text: "Looking for warm skin through grass and shrubs.",
              },
              {
                step: "02",
                icon: "🧥",
                title: "Mesh blocks them",
                text: "Noseeum-grade mesh is too fine for any tick to penetrate.",
              },
              {
                step: "03",
                icon: "💨",
                title: "Air gap protects",
                text: "The space between mesh and skin keeps ticks at distance.",
              },
              {
                step: "04",
                icon: "✅",
                title: "You enjoy outside",
              ...
              >
                ...
                <div style={{ fontSize: isMobile ? 22 : 28, marginBottom: 8 }}>
                  {s.icon}
                </div>
                <div
                  style={{
      ...
      <section style={{ padding: pad(isMobile), background: c.dark }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 32 }}>
            ...
            >
              Watch how Bug Away works in real conditions — hiking, gardening,
              playing outside.
            </p>
          </div>
          {/* 
      ...
      >
        {[
          {
            url: "/images/lifestyle-kids-forest.png",
            label: "Family Protection",
          },
          {
            url: "/images/lifestyle-women-outdoor.png",
            label: "Adventure Ready",
          },
          {
            url: "/images/lifestyle-men-outdoor.png",
            label: "Adventure Ready",
          },
        ]
      ...
      <div
        style={{
          background: c.sageD,
          padding: isMobile ? "20px 16px" : "24px 60px",
          display: "grid",
            ...
            {[
              {
                emoji: "🥾",
                title: "Hikers",
                text: "Hours in the forest without constantly checking for ticks. Focus on the trail, not the bugs.",
                img: "/images/lifestyle-couple-forest.png",
              },
              {
                emoji: "🌿",
                title: "Gardeners",
                text: "Weeding, planting, pruning — tick territory. Bug Away lets you garden without worry.",
                img: "/images/lifestyle-women-outdoor.png",
              },
              {
                emoji: "👨‍👩‍👧",
                title: "Families",
                text: "Kids playing in tall grass or exploring nature — protected without any chemical sprays.",
                img: "/images/lifestyle-kids-forest.png",
              },
            ].map((u, i) => (
              <div
      ...
      <section style={{ padding: pad(isMobile), background: c.off }}>
        ...
        >
          ...
          <div style={{ display: "flex", gap: 4, alignItems: "center" }}>
            <div style={{ display: "flex", gap: 1 }}>
              {[...Array(5)].map((_, i) => (
                <span key={i} style={{ color: "#F0B429", fontSize: 16 }}>
                  ★
                </span>
              ))}
            </div>
      ...
      <section style={{ padding: pad(isMobile), background: c.off }}>
        <div style={{ maxWidth: 700, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 24 }}>
            ...
            <h2 style={{ ...H2, marginBottom: 8, textAlign: "center" }}>
              Know your risk
            </h2>
            <p
              style={{
      ...
      >
        <div style={{ maxWidth: 600, margin: "0 auto", textAlign: "center" }}>
          ...
          >
            Ready for tick-free adventures?
          </h2>
          <p
            style={{
              fontSize: 14,
          ...
          >
            Join 500+ outdoor enthusiasts who have already discovered the
            difference.
          </p>
          <Link
            to="/shop"
