  ...
  return (
    <div>
      <section style={{
        ...
        background: `linear-gradient(to right, rgba(30,50,40,.75) 55%, rgba(30,50,40,.35) 100%), url("/images/combo-lifestyle-couple-forest-trail.jpg") center/cover no-repeat`,
        ...
        <div style={{ textAlign: "center", color: "#fff", padding: isMobile ? "40px 24px" : "60px 40px", maxWidth: 600 }}>
          ...
          <p style={{ fontSize: 16, opacity: 0.9, lineHeight: 1.6, marginBottom: 8 }}>
            Gloves, gaiters, head nets and more. Complete your protection setup with chemical-free mesh accessories.
          </p>
      ...
      <section style={{ background: "#fff", padding: isMobile ? "48px 20px" : "72px 40px" }}>
        <div style={{ maxWidth: 500, margin: "0 auto", textAlign: "center" }}>
          ...
          <p style={{ color: "#666", fontSize: 15, lineHeight: 1.6, marginBottom: 32 }}>
            We are expanding our range with mesh gloves, gaiters and head nets. Sign up to get notified when they drop and receive an exclusive early-bird discount.
          </p>
          ...
          {submitted ? (
            <div style={{ background: "#F0F5F2", borderRadius: 12, padding: 24 }}>
              ...
              <p style={{ fontSize: 13, color: "#888" }}>We'll email you as soon as accessories are available.</p>
            </div>
          ) : (
