  ...
  if (hasMenJacket && !hasMenPants) {
    upsell = {
      ...
      product: {
        ...
        price: SINGLE_PRICE,
        images: ["/images/lifestyle-men-outdoor.png"],
    ...
    upsell = {
      ...
      product: {
        ...
        price: SINGLE_PRICE,
        images: ["/images/product-men-jacket-front.png"],
    ...
    upsell = {
      ...
      product: {
        ...
        price: SINGLE_PRICE,
        images: ["/images/lifestyle-women-outdoor.png"],
      ...
      >
        ...
        <div style={{ flex: 1, overflowY: "auto", padding: "16px 20px" }}>
              ...
              >
                <div
                  style={{
                    ...
                    borderRadius: 8,
                    overflow: "hidden",
                    background: item.product.placeholderBg + "55",
                    flexShrink: 0,
                  }}
                >
                  <img
          ...
          {upsell && items.length > 0 && (
            <div
              style={{
                background: `linear-gradient(135deg,${c.skyP} 0%,${c.sageL}44 100%)`,
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                <div
                  style={{
                    ...
                    borderRadius: 6,
                    overflow: "hidden",
                    background: upsell.product.placeholderBg + "55",
                    flexShrink: 0,
                  }}
                >
                  <img
                ...
                <div style={{ flex: 1 }}>
                  ...
                  >
                    ...
                    >
                      € {upsell.product.price.toFixed(2).replace(".", ",")}
                    </span>
        ...
        {items.length > 0 && (
          <div style={{ borderTop: `1px solid ${c.glL}`, flexShrink: 0 }}>
            <div
              style={{ display: "flex", borderBottom: `1px solid ${c.glL}` }}
            >
              <button
                onClick={() => {
                ...
                style={{
                  ...
                  background: "none",
                  border: "none",
                  borderRight: `1px solid ${c.glL}`,
                  cursor: "pointer",
                  fontSize: 12,
                  fontFamily: "'Poppins',sans-serif",
                  color: showDiscount ? c.sageD : c.grayD,
              ...
              <button
                ...
                style={{
                  ...
                  fontSize: 12,
                  fontFamily: "'Poppins',sans-serif",
                  color: showNotes ? c.sageD : c.grayD,
