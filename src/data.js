...
export const products = [
  ...
  },
  {
    ...
    features: [
      "Jacket + pants included",
      "Safe elastic hood (no drawstrings)",
      "Integrated foot cover",
      "Extra pockets",
...
export const reviews = [
  {
    ...
    name: "Maaike V.",
    rating: 5,
    text: "Finally something that actually keeps ticks away. Wore it hiking all weekend — not a single bite.",
    product: "ba-jacket-men",
  },
  {
    id: 2,
    name: "James R.",
    rating: 5,
    text: "My whole family wears these now. Kids can play in the forest without us constantly checking.",
    product: "ba-kids-set",
  },
  {
    id: 3,
    name: "Sophie L.",
    rating: 5,
    text: "The integrated foot cover is genius. No more tucking trousers into socks.",
    product: "ba-pants-women",
  },
  {
    id: 4,
    name: "Bart M.",
    rating: 4,
    text: "Lightweight, breathable, does exactly what it says. Great for gardening too.",
    product: "ba-jacket-women",
  },
];
